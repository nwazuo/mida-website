...
export default function MidaLink(props: Props) {
  ...
  return (
    ...
    >
      ...
      {/* arrow */}
      <svg className="top-[2px] left-[6px] relative w-[12px] lg:w-[21px]" width="22" height="17" viewBox="0 0 22 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M13.5418 16.9429L11.6618 14.9957L16.429 10.2286H0.113281V7.5429H16.429L11.6618 2.77576L13.5418 0.828613L21.599 8.88575L13.5418 16.9429Z" fill="#061433" />
      </svg>
    </Link>
  )
}